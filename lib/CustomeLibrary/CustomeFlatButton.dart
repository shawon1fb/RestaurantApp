...
/// {@tool sample}
///
/// This example shows a simple [CustomeFlatButton].
///
/// ```dart
/// FlatButton(
///   onPressed: () {
...
/// {@tool sample}
///
/// This example shows a [CustomeFlatButton] that is normally white-on-blue,
...
class CustomeFlatButton extends MaterialButton {
  /// Create a simple text button.
  const CustomeFlatButton({
    Key key,
  ...
  factory CustomeFlatButton.icon({
    Key key,
    @required VoidCallback onPressed,
    ValueChanged<bool> onHighlightChanged,
    ButtonTextTheme textTheme,
...
/// The type of of FlatButtons created with [CustomeFlatButton.icon].
///
/// This class only exists to give FlatButtons created with [CustomeFlatButton.icon]
/// a distinct class for the sake of [ButtonTheme]. It can not be instantiated.
class _FlatButtonWithIcon extends CustomeFlatButton with MaterialButtonWithIconMixin {
  _FlatButtonWithIcon({
    Key key,
    @required VoidCallback onPressed,
    ValueChanged<bool> onHighlightChanged,
